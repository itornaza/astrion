...
class Keywords:
    ...
    planets_ = {
        SUN: [
            ...
            "creative impulse","self awareness"
        ],
        ...
        PLUTO: [
            ...
            "power and control", 
            "purging and elimination",
            "profound change", 
            "intensity", "buried secrets"
        ]
    }
    ...
    houses_ = {
        FIRST: [
            ...
            "approach to life", 
            "beginnings", 
            "capacity and desire for self-development", 
            "early experiences", 
            "personal identification", 
            "outer appearances-approach"
        ],
        ...
        FOURTH: [
            ...
            "private place of retreat", 
            "endings and completion", 
            "mines", 
            "lands/non-moveable property", 
            "storage/protective space", 
            "heritage", 
            "inner base", 
            "private life", 
            "foundations"
        ...
        FIFTH: [
            "creativity and joyful pursuits", 
            "children", 
            "pregnancy", 
            "love affairs", 
            "games", 
            ...
            "having fun", 
            "love affairs", 
            "things that affirm our creativity and joyfulness", 
            "what we play at", 
            "gambling", 
            "speculation", 
            "pleasure", 
        ...
        SIXTH: [
            "the routines of the physical world", 
            "duty", 
            "work", 
            "health", 
            "service", 
            "attitude to work", 
            "bodily functions", 
            "servants/practical caretakers", 
            "daily functioning", 
            "rituals", 
            "employment – earning our daily bread", 
            "work colleagues", 
            "employees", 
            "those who serve us", 
            "pets", 
        ...
        SEVENTH: [
            "Open relationships to the other", 
            "marriage", 
        ...
        EIGHT: [
            "hidden relationships to the other", 
            "emotional bonds", 
            "joint finances or money belonging to others", 
            "taxes", 
            "loans", 
            "debts", 
            "death", 
        ...
        TENTH: [
            "worldly position and responsibility", 
            "job", 
            "career", 
            "public image", 
            "authority figures", 
            ...
            "public image and standing in the world", 
            "rulers", 
            "kings", 
            "employers", 
            "ambitions", 
        ...
        ELEVENTH: [
            "relationship to groups and to the collective", 
            "friendship", 
            "hopes and wishes", 
            "ideals and ideology", 
            "shared aims", 
        ...
        TWELVTH: [
            "the desire to retreat or escape", 
            "institutions", 
            "hospitals", 
            "monasteries", 
            "sorrow", 
            ...
            "asylums", 
            "retreats/escapes", 
            "places that are removed from the world", 
            "hidden enemies", 
            "self-undoing", 
            "mysticism", 
            "secrets", 
    ...
    modes_ = {
        CARDINAL: [
            ...
            "accept challenges", 
            "goal oriented", 
            "centrifugal radiating energy"
        ],

        FIXED: [
            "steadfast", 
            "stable", 
            "concentrate energy and sustain it", 
            "consolidate", "put down roots", 
        ...
        MUTABLE: [
            "adaptable", 
            "flexible", 
            "disperse, distribute and transform energy", 
            "state of flux", 
            "restless", 
            "changeable", 
            "going with the flow", 
            "changing direction", 
            "resolve stalemates", "versatile", 
            "restless"
        ]
    }
    ...
    patterns_ = {
        T_SQUARE: [
            "Inner tension and drive for active integration and manifestation",
        ...
        GRAND_CROSS: [
            "Describes a person that is driven and fiercely self-sufficient, who may have to learn the "
        ...
        HARD_RECTANGLE: [
            "As in the T-square, the conflicts and strengths of the oppositions are likely to be "
            "intensified by the additional strain of the semisquares and sesquiquadrates"                 
        ],

        GRAND_TRINE: [
            "The emphasis on 3-ness indicates a high degree of harmony, enjoyment and contentment",
        ...
        MINOR_GRAND_TRINE: [
            "The principle of focal planet forming the sextiles, brings extra opportunity for "
        ...
        YOD: [
            "The focal point stabilizes and drives this configuration",
        ...
        MYSTIC_RECTANGLE: [
            "The two trines and two sextiles enable the inner tensions of the oppositions to "
            "be resolved",
        ...
        STELLIUM: [
            "Caution: 3 or more planets in the same sign and house in conjunction by association",
    ...
    lunar_phases_ = {
        NEW_MOON: [
            "Involved at the beginnings of things", 
        ...
        FIRST_QUARTER: [
            "Builders or activists of one sort or another",
            "Strong willed",
            "Energetic",
        ...
        FULL_MOON: [
            "Capacity for visionary thought",
